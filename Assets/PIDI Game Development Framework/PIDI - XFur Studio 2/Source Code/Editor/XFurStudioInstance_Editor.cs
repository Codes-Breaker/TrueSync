        ...
        public override void OnInspectorGUI() {
            ...
            if ( xfur.FurDatabase != null && xfur.MainRenderer.renderer != null ) {
                ...
                if ( BeginCenteredGroup( "GENERAL SETTINGS", ref xfur.folds[0] ) ) {
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label( randomModule.moduleName + ", v" + randomModule.version, pidiSkin2.label, GUILayout.Width( 140 ) );
                    GUILayout.Space( 64 );
                    GUILayout.Label( " Status : " + randomModule.ModuleStatus, pidiSkin2.label );
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label( lodModule.moduleName + ", v" + lodModule.version, pidiSkin2.label, GUILayout.Width( 140 ) );
                    GUILayout.Space( 64 );
                    GUILayout.Label( " Status : " + lodModule.ModuleStatus, pidiSkin2.label );
                    GUILayout.FlexibleSpace();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label( physicsModule.moduleName + ", v" + physicsModule.version, pidiSkin2.label, GUILayout.Width( 140 ) );
                    GUILayout.Space( 64 );
                    GUILayout.Label( " Status : " + physicsModule.ModuleStatus, pidiSkin2.label );
                    GUILayout.FlexibleSpace();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label( vfxModule.moduleName + ", v" + vfxModule.version, pidiSkin2.label, GUILayout.Width( 140 ) );
                    GUILayout.Space( 64 );
                    GUILayout.Label( " Status : " + vfxModule.ModuleStatus, pidiSkin2.label );
                    GUILayout.FlexibleSpace();
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label( decalsModule.moduleName + ", v" + decalsModule.version, pidiSkin2.label, GUILayout.Width( 140 ) );
                    GUILayout.Space( 64 );
                    GUILayout.Label( " Status : " + decalsModule.ModuleStatus, pidiSkin2.label );
                    GUILayout.FlexibleSpace();
                        ...
                        if ( xfur.MainRenderer.isFurMaterial[i] ) {
                            ...
                            if ( BeginCenteredGroup( "Material : " + xfur.MainRenderer.renderer.sharedMaterials[i].name + " - Fur Profile", ref xfur.profileFolds[i] ) ) {
                                ...
                                */
                                ...
                                if ( xfur.FurDataProfiles[i].FurColorTiling == Vector4.zero ) {
                                    xfur.FurDataProfiles[i].FurColorTiling = new Vector4( xfur.FurDataProfiles[i].FurBaseTiling, xfur.FurDataProfiles[i].FurBaseTiling ,0,0);
                                }
                                
                                xfur.FurDataProfiles[i].FurColorTiling = EditorGUILayout.Vector4Field( new GUIContent( "Color/Normal Map Tiling & Offset" ), xfur.FurDataProfiles[i].FurColorTiling );

                                if ( xfur.FurDatabase.UseNormalmaps ) {

                                    xfur.FurDataProfiles[i].FurNormalmap = ObjectField<Texture>( new GUIContent( "Fur Normalmap", "The normalmap to be applied to the whole surface of the model" ), xfur.FurDataProfiles[i].FurNormalmap );
