...
namespace XFurStudio3.Core {
    ...
    public class XFurTemplate {
        ...
        public XFurTemplate( bool withDefaults ) {
            ...
            FurUVTiling = 2;
            FurColorTiling = new Vector4( 1, 1, 0, 0 );
    ...
    [CreateAssetMenu( fileName = "New Fur Profile Asset", menuName = "XFur Studio 3/New Fur Profile Asset" )]
    public class XFurStudioFurProfile : ScriptableObject {

#if UNITY_EDITOR
        public string Version { get { return "v2.5.0"; } }
#endif
