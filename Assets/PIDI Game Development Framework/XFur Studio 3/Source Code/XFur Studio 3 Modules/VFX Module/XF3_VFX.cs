...
namespace XFurStudio3.Modules {
    ...
    [System.Serializable]
    public class XF3_VFX : XFurStudioModule {
        ...
        public override void Load() {
            ...
            for ( int i = 0; i < vfxTexture.Length; i++ ) {
                ...
                if ( Owner.MainRenderer.isFurMaterial[i] ) {
                    ...
                    vfxTexture[i].wrapMode = TextureWrapMode.Clamp;
                    XFurStudioAPI.LoadPaintResources();
                    XFurStudioAPI.FillTexture( Owner, Color.black, vfxTexture[i], Color.black );
                    vfxTexture[i].name = "XFUR3_VFX" + i + "_" + Owner.name;
                }
            }
        ...
        public override void MainRenderLoop( MaterialPropertyBlock block, int furProfileIndex ) {
            ...
            if ( furProfileIndex > -1 && furProfileIndex < vfxTexture.Length ) {
            ...
            for ( int i = 0; i < vfxTexture.Length; i++ ) {
                ...
                if ( vfxTexture[i] && Owner.MainRenderer.isFurMaterial[i] ) {
                    ...
                    if ( XFurStudioInstance.WindZone ) {
                        ...
                        vfxMat.SetVector( _xfurVFXDirection1, Vector3.down );
                        vfxMat.SetVector( _xfurVFXDirection2, Vector3.down );
                    }
                    ...
                    XFurStudioAPI.LoadPaintResources();
                    XFurStudioAPI.FillUVCracks( xfurInstance, vfxTexture[i], i );
        ...
        public override void UpdateModule() {
            ...
            if ( !VFXProgressiveShader ) {
                VFXProgressiveShader = Shader.Find( "Hidden/XFur Studio 3/VFX/VFXProgressive" );
        ...
        public override void ModuleUI() {
            ...
            if ( !Application.isPlaying )
                updateTime = EditorGUILayout.FloatField( new GUIContent( "Update Frequency (s)", "The update frequency (in seconds) of this module" ), Mathf.Clamp( updateTime, 0.01f, 1 ) );
            ...
            if ( BeginCenteredGroup( "Rain FX", ref fxFolds[1] ) ) {
                ...
                Rain.smoothness = EditorGUILayout.Slider( new GUIContent( "Smoothness" ), Rain.smoothness, 0.25f, 1.0f );
            ...
            if ( BeginCenteredGroup( "Blood FX", ref fxFolds[2] ) ) {
                ...
                Blood.smoothness = EditorGUILayout.Slider( new GUIContent( "Smoothness" ), Blood.smoothness, 0.25f, 1.0f );
                GUILayout.Space( 8 );
