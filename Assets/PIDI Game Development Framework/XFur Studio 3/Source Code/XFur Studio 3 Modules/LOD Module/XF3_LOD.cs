...
namespace XFurStudio3.Modules {
    ...
    [System.Serializable]
    public class XF3_LOD : XFurStudioModule {
        ...
        public override void ModuleUI() {
            ...
            if ( useOverdrawReduction ) {
                ...
                overdrawLODArea = EditorGUILayout.Slider( new GUIContent( "Overdraw Reduction Area" ), overdrawLODArea, 0.15f, 12 );
            ...
            if ( SwitchToBasicShells ) {
                ...
                BasicShellsRegion.x = EditorGUILayout.Slider( new GUIContent( "Switch At Distance" ), BasicShellsRegion.x, MinFurDistance, MaxFurDistance );
            }
