...
namespace XFurStudio3.Modules {
    ...
    [System.Serializable]
    public class XF3_Random : XFurStudioModule {
        ...
        public XF3_Random( XF3_Random source ) {
                            ...
                            switch ( RandomSettings[i].RandomizationMode ) {
                                ...
                                case 0:
                                    ...
                                    if ( RandomSettings[i].RandomizeColorMix ) {
                                        ...
                                        if ( RandomSettings[i].RandomizeTo.FurColorVariation ) {
                                            GUILayout.Space( 8 );
                                            RandomSettings[i].RandomizeTo.FurColorA = EditorGUILayout.ColorField( new GUIContent( "Fur Color A", "The fur color to be applied on the red channel of the Color Variation map" ), RandomSettings[i].RandomizeTo.FurColorA );
                                            RandomSettings[i].RandomizeTo.FurColorB = EditorGUILayout.ColorField( new GUIContent( "Fur Color B", "The fur color to be applied on the green channel of the Color Variation map" ), RandomSettings[i].RandomizeTo.FurColorB );
                                            RandomSettings[i].RandomizeTo.FurColorC = EditorGUILayout.ColorField( new GUIContent( "Fur Color C", "The fur color to be applied on the blue channel of the Color Variation map" ), RandomSettings[i].RandomizeTo.FurColorC );
                                            RandomSettings[i].RandomizeTo.FurColorD = EditorGUILayout.ColorField( new GUIContent( "Fur Color D", "The fur color to be applied on the alpha channel of the Color Variation map" ), RandomSettings[i].RandomizeTo.FurColorD );
                                        }
                                    }
                                    ...
                                    RandomSettings[i].RandomizeTo.FurShadowsTint = EditorGUILayout.ColorField( new GUIContent( "Occlusion Tint" ), RandomSettings[i].RandomizeTo.FurShadowsTint );
                                    RandomSettings[i].RandomizeTo.FurOcclusion = EditorGUILayout.Slider( new GUIContent( "Fur Occlusion / Shadowing", "The shadowing applied over the surface of the fur strands as a simple occlusion pass. Multiplied by the per-profile occlusion value and the one painted through XFur Studio™ - Designer" ), RandomSettings[i].RandomizeTo.FurOcclusion, 0, 1 );
                                    RandomSettings[i].RandomizeTo.FurOcclusionCurve = EditorGUILayout.Slider( new GUIContent( "Fur Occlusion Curve", "How the shadowing / occlusion of the fur will go from the root to the tip of each strand" ), RandomSettings[i].RandomizeTo.FurOcclusionCurve, 0, 1 );
